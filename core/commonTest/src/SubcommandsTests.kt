...
class SubcommandsTests {
    ...
    fun testSubcommand() {
        ...
        class Summary: SubcommandWithoutExit("summary", "Calculate summary") {
    ...
    fun testStrictSubcommandOptionsOrder() {
        val argParserStrictFail = ArgParserWithoutExit("testParser", strictSubcommandOptionsOrder = true)
        ...
        val argParserStrict = ArgParserWithoutExit("testParser", strictSubcommandOptionsOrder = true)
        val action = Summary()
    ...
    fun testCommonOptions() {
        ...
        val argParserSubtraction = ArgParserWithoutExit("testParser")
    ...
    fun testRecursiveSubcommands() {
        ...
        class Calculation: SubcommandWithoutExit("calc", "Execute calculation") {
            init {
                subcommands(Summary())
            }
            val invert by option(ArgType.Boolean, "invert", "i", "Invert results")
    ...
    fun testCommonDefaultInSubcommand() {
        val parser = ArgParserWithoutExit("testParser")
        ...
        class Multiply: SubcommandWithoutExit("mul", "Multiply") {
